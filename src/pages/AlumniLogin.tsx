    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="w-full max-w-md animate-fade-in">
        ...
        <div className="rounded-2xl border border-border bg-card p-8 shadow-sm">
          ...
          {resetSent && <div className="mb-4 rounded-lg bg-success/10 p-3 text-sm text-success">Password reset link sent!</div>}
          ...
          {forgotMode ? (
            ...
            <>
              ...
              <p className="mt-4 text-center text-sm text-muted-foreground">
                Don't have an account? <Link to="/alumni/register" className="font-medium text-primary hover:underline">Register</Link>
              </p>
            </>
          )}
        </div>
